...
export const createFilmCard = (film) => {
  const { title, poster, description, commentsCount, realizeDate, rating, duration, genre, isWatchList, isHistoryList, isFavoriteList } = film;
  ...
  <a class="film-card__comments">${commentsCount} comments</a><div class="film-card__controls">
